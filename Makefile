...
ifeq ($(CCI_KLOG),1)
	ifndef CONFIG_CCI_KLOG
		KBUILD_CFLAGS	+= -DCONFIG_CCI_KLOG=n
	endif # ifndef CONFIG_CCI_KLOG
	KBUILD_CFLAGS	+= -DCCI_KLOG=n
...
ifeq ($(CCI_FORCE_RAMDUMP),1)
		KBUILD_CFLAGS	+= -DCCI_FORCE_RAMDUMP=n
endif
#/* KevinA_Lin, 20140205 */

#/* KevinA_Lin, 20140612 */
ifeq ($(CCI_WAKELOCK_DEBUG),1)
		KBUILD_CFLAGS	+= -DCCI_WAKELOCK_DEBUG=n
endif
#/* KevinA_Lin, 20140612 */
...
ifeq ($(CCI_TRACE_INIT_SERVICE),1)
	KBUILD_CFLAGS	+= -DCCI_TRACE_INIT_SERVICE=n
endif
